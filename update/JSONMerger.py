...
# Simple function to set output file and check if inputs exist, could add more error checking but this is just called by a bash script anyways..
def get_Arguments(argv):
    # Set output file var up
    global out
    n = len(argv)
